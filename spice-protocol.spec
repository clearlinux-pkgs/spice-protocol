...
Source0  : https://gitlab.freedesktop.org/spice/spice-protocol/-/archive/v0.14.4/spice-protocol-v0.14.4.tar.gz
...
%prep
%setup -q -n spice-protocol-v0.14.4
cd %{_builddir}/spice-protocol-v0.14.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648055584
...
cp %{_builddir}/spice-protocol-v0.14.4/COPYING %{buildroot}/usr/share/package-licenses/spice-protocol/7e915fa295db356dc2f82929681d82ac4f7f961d
